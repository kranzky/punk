...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new("1.2.0")
      s.add_runtime_dependency("bootsnap".freeze, ["~> 1.7"])
      s.add_runtime_dependency("dim".freeze, ["~> 1.2"])
      s.add_runtime_dependency("wisper".freeze, ["~> 2.0"])
      s.add_runtime_dependency("papertrail".freeze, ["~> 0.11"])
      s.add_runtime_dependency("semantic_logger".freeze, ["~> 4.7"])
      s.add_runtime_dependency("dotenv".freeze, ["~> 2.7"])
      s.add_runtime_dependency("dot_hash".freeze, ["~> 1.1"])
      s.add_runtime_dependency("commander".freeze, ["~> 4.5"])
      s.add_runtime_dependency("pry".freeze, ["~> 0.14"])
      s.add_runtime_dependency("puma".freeze, ["~> 5.2"])
      s.add_runtime_dependency("rack-cors".freeze, ["~> 1.1"])
      s.add_runtime_dependency("rack-protection".freeze, ["~> 2.1"])
      s.add_runtime_dependency("rack-ssl-enforcer".freeze, ["~> 0.2"])
      s.add_runtime_dependency("rack-unreloader".freeze, ["~> 1.7"])
      s.add_runtime_dependency("dalli".freeze, ["~> 2.7"])
      s.add_runtime_dependency("pg".freeze, ["~> 1.2"])
      s.add_runtime_dependency("sequel_pg".freeze, ["~> 1.14"])
      s.add_runtime_dependency("sequel".freeze, ["~> 5.42"])
      s.add_runtime_dependency("aasm".freeze, ["~> 5.1"])
      s.add_runtime_dependency("http-accept".freeze, ["~> 2.1"])
      s.add_runtime_dependency("ipstack".freeze, ["~> 0.1"])
      s.add_runtime_dependency("rbnacl".freeze, ["~> 7.1"])
      s.add_runtime_dependency("userstack".freeze, ["~> 0.1"])
      s.add_runtime_dependency("sidekiq".freeze, ["~> 6.1"])
      s.add_runtime_dependency("sidekiq-cron".freeze, ["~> 1.2"])
      s.add_runtime_dependency("mailgun-ruby".freeze, ["~> 1.2"])
      s.add_runtime_dependency("plivo".freeze, ["~> 4.16"])
      s.add_runtime_dependency("roda".freeze, ["~> 3.41"])
      s.add_runtime_dependency("roda-route_list".freeze, ["~> 2.1"])
      s.add_runtime_dependency("slim".freeze, ["~> 4.1"])
      s.add_runtime_dependency("jbuilder".freeze, ["~> 2.11"])
      s.add_runtime_dependency("oj".freeze, ["~> 3.11"])
      s.add_runtime_dependency("tilt-jbuilder".freeze, ["~> 0.7"])
      s.add_runtime_dependency("rdoc".freeze, ["~> 6.3"])
      s.add_runtime_dependency("swagger_yard".freeze, ["~> 1.0"])
      s.add_runtime_dependency("activesupport".freeze, ["~> 6.1"])
      s.add_runtime_dependency("sentry-ruby".freeze, ["~> 4.2"])
      s.add_runtime_dependency("sentry-sidekiq".freeze, ["~> 4.2"])
      s.add_runtime_dependency("skylight".freeze, ["~> 4.3"])
      s.add_runtime_dependency("phony".freeze, ["~> 2.18"])
      ...
      s.add_development_dependency("amazing_print".freeze, ["~> 1.2"])
      s.add_development_dependency("byebug".freeze, ["~> 11.1"])
      s.add_development_dependency("launchy".freeze, ["~> 2.5"])
    else
      s.add_dependency("bootsnap".freeze, ["~> 1.7"])
      s.add_dependency("dim".freeze, ["~> 1.2"])
      s.add_dependency("wisper".freeze, ["~> 2.0"])
      s.add_dependency("papertrail".freeze, ["~> 0.11"])
      s.add_dependency("semantic_logger".freeze, ["~> 4.7"])
      s.add_dependency("dotenv".freeze, ["~> 2.7"])
      s.add_dependency("dot_hash".freeze, ["~> 1.1"])
      s.add_dependency("commander".freeze, ["~> 4.5"])
      s.add_dependency("pry".freeze, ["~> 0.14"])
      s.add_dependency("puma".freeze, ["~> 5.2"])
      s.add_dependency("rack-cors".freeze, ["~> 1.1"])
      s.add_dependency("rack-protection".freeze, ["~> 2.1"])
      s.add_dependency("rack-ssl-enforcer".freeze, ["~> 0.2"])
      s.add_dependency("rack-unreloader".freeze, ["~> 1.7"])
      s.add_dependency("dalli".freeze, ["~> 2.7"])
      s.add_dependency("pg".freeze, ["~> 1.2"])
      s.add_dependency("sequel_pg".freeze, ["~> 1.14"])
      s.add_dependency("sequel".freeze, ["~> 5.42"])
      s.add_dependency("aasm".freeze, ["~> 5.1"])
      s.add_dependency("http-accept".freeze, ["~> 2.1"])
      s.add_dependency("ipstack".freeze, ["~> 0.1"])
      s.add_dependency("rbnacl".freeze, ["~> 7.1"])
      s.add_dependency("userstack".freeze, ["~> 0.1"])
      s.add_dependency("sidekiq".freeze, ["~> 6.1"])
      s.add_dependency("sidekiq-cron".freeze, ["~> 1.2"])
      s.add_dependency("mailgun-ruby".freeze, ["~> 1.2"])
      s.add_dependency("plivo".freeze, ["~> 4.16"])
      s.add_dependency("roda".freeze, ["~> 3.41"])
      s.add_dependency("roda-route_list".freeze, ["~> 2.1"])
      s.add_dependency("slim".freeze, ["~> 4.1"])
      s.add_dependency("jbuilder".freeze, ["~> 2.11"])
      s.add_dependency("oj".freeze, ["~> 3.11"])
      s.add_dependency("tilt-jbuilder".freeze, ["~> 0.7"])
      s.add_dependency("rdoc".freeze, ["~> 6.3"])
      s.add_dependency("swagger_yard".freeze, ["~> 1.0"])
      s.add_dependency("activesupport".freeze, ["~> 6.1"])
      s.add_dependency("sentry-ruby".freeze, ["~> 4.2"])
      s.add_dependency("sentry-sidekiq".freeze, ["~> 4.2"])
      s.add_dependency("skylight".freeze, ["~> 4.3"])
      s.add_dependency("phony".freeze, ["~> 2.18"])
      s.add_dependency("bundler".freeze, ["~> 1.17"])
      s.add_dependency("gemfile_updater".freeze, ["~> 0.1"])
      s.add_dependency("juwelier".freeze, ["~> 2.4"])
      s.add_dependency("amazing_print".freeze, ["~> 1.2"])
      s.add_dependency("byebug".freeze, ["~> 11.1"])
      s.add_dependency("launchy".freeze, ["~> 2.5"])
    end
  else
    s.add_dependency("bootsnap".freeze, ["~> 1.7"])
    s.add_dependency("dim".freeze, ["~> 1.2"])
